document.getElementById('downloadBtn').addEventListener('click', function() {
    ...
    link.download = 'diapositivas tecnicas grupales.pdf'; // Nombre del archivo que se descargará
    link.click();
  });
  ...
  document.getElementById('whatsappBtn').addEventListener('click', function() {
    ...
    const whatsappUrl = `https://api.whatsapp.com/send?text=Mira%20Esta%20Es%20La%20Página%20De%20La%20Tecnica%20Grupal:%20Mesa%20Redonda.`;
